...
public class AppStart {
    ...
    public void joao(){
     ...
     public void test(){
        ...
        String[] twoMeterContacts = test.getContacts(testUsers[0], 2);
        System.out.println("Contacts from (2 meters) : " + testUsers[0].getCurrentIDToCastString());
        for (String buffer : twoMeterContacts){
            System.out.println("Contact : " + buffer);
        }

        String[] fourMeterContacts = test.getContacts(testUsers[0], 4);
        System.out.println("Contacts from (4 meters) : " + testUsers[0].getCurrentIDToCastString());
